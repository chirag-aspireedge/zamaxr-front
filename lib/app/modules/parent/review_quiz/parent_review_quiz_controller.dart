...
class ParentReviewQuizController extends GetxController {
  final RxString quizTitle = 'Cell Structure Quiz'.obs;
  final RxString subject = 'Science Grade 8'.obs;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text('Options (select correct answer):', style: TextStyle(fontWeight: FontWeight.w600)),
    ...
    if (Get.context == null) {
      ...
      questions.add(
        ReviewQuizQuestionItem(
          ...
          number: newIndex.toString(),
          timeEstimate: '30 sec',
          seconds: 30,
          question: 'New question about cell biology?',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              TextField(controller: opt1Ctrl, decoration: const InputDecoration(labelText: 'Option 1', border: OutlineInputBorder(), isDense: true)),
              const SizedBox(height: 8),
              TextField(controller: opt2Ctrl, decoration: const InputDecoration(labelText: 'Option 2', border: OutlineInputBorder(), isDense: true)),
              const SizedBox(height: 8),
              TextField(controller: opt3Ctrl, decoration: const InputDecoration(labelText: 'Option 3', border: OutlineInputBorder(), isDense: true)),
              const SizedBox(height: 8),
              TextField(controller: opt4Ctrl, decoration: const InputDecoration(labelText: 'Option 4', border: OutlineInputBorder(), isDense: true)),
              const SizedBox(height: 16),
              SizedBox(
                width: double.infinity,
                height: 48,
  ...
  void onCreateQuiz() {
    ...
    // Navigate to Parent Quiz Loading View
    Get.toNamed(
      Routes.PARENT_QUIZ_LOADING,
      arguments: {
