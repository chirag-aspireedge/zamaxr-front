...
import 'parent_ai_quiz_controller.dart';

class ParentAiQuizView extends GetView<ParentAiQuizController> {
  const ParentAiQuizView({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<ParentAiQuizController>()) {
      Get.put(ParentAiQuizController());
    }
  ...
  // Section 2: AI Instructions Header
  ...
  // Section 2: AI Instructions Textarea
  ...
  // Section 4: Question Type Selector
