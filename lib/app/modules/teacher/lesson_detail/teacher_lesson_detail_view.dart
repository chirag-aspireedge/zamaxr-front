...
import 'teacher_lesson_detail_controller.dart';
import 'teacher_lesson_detail_model.dart';

class TeacherLessonDetailView extends GetView<TeacherLessonDetailController> {
  const TeacherLessonDetailView({super.key});
  ...
  // ---------------------------------------------------------------------------
  Widget _buildTopAppBar(BuildContext context, TeacherLessonDetailModel data) {
    return Padding(
  ...
  // ---------------------------------------------------------------------------
  Widget _buildLessonHeader(TeacherLessonDetailModel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  // Section 1: About This Lesson
  // ---------------------------------------------------------------------------
  Widget _buildSectionAbout(TeacherLessonDetailModel data) {
    return Container(
  ...
  // Section 2: Documents
  // ---------------------------------------------------------------------------
  Widget _buildSectionDocuments(TeacherLessonDetailModel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(
  ...
  // Section 3: Videos
  // ---------------------------------------------------------------------------
  Widget _buildSectionVideos(TeacherLessonDetailModel data) {
  ...
  // ---------------------------------------------------------------------------
  Widget _buildSectionAudio(TeacherLessonAudio audio) {
  ...
  // Section 5: Images
  // ---------------------------------------------------------------------------
  Widget _buildSectionImages(TeacherLessonDetailModel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  // ---------------------------------------------------------------------------
  Widget _buildSectionAssessments(TeacherLessonQuizItem? quiz) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                color: const Color(0xFF127FD2).withValues(alpha: 0.35),
                width: 1,
              ),
            ),
            child: Row(
  ...
  // ---------------------------------------------------------------------------
  Widget _buildSectionImmersive(TeacherLessonDetailModel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(
  ...
  Widget _buildImmersiveCard({
    required TeacherLessonImmersiveItem item,
