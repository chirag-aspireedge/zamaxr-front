...
import 'teacher_edit_lesson_controller.dart';

class EditLessonView extends GetView<EditLessonController> {
  const EditLessonView({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<EditLessonController>()) {
      Get.put(EditLessonController());
    }
            ...
            children: [
              ...
              Expanded(
                child: _buildUploadCard(
                  ...
                  label: 'Assessments',
                  onTap: controller.onAssessments,
                ),
              ),
            ],
          ),
...
typedef TeacherEditLessonView = EditLessonView;
