...
import '../modules/individual/registration/individual_registration_controller.dart';
...
class AllControllerBindings extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<IndividualRegistrationController>(() => IndividualRegistrationController(), fenix: true);
